...
unsigned arch_bits(Arch a) noexcept {
    switch (a) {
        ...
        case Arch::Mips:
        case Arch::Ppc:
        case Arch::Riscv32: return 32;
        case Arch::X86_64:
        case Arch::Aarch64:
        case Arch::Mips64:
        case Arch::Ppc64:
        case Arch::Riscv64: return 64;
        case Arch::Unknown: return 0;
    }
    return 0;
}
...
Endian default_endian(Arch a) noexcept {
    switch (a) {
        case Arch::Ppc:
        case Arch::Ppc64: return Endian::Big;
        default:          return Endian::Little;
    }
}
