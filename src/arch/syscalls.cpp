...
constexpr std::array<Entry, 38> kX86_64 = {{
    ...
    {9, "mmap"},         {10, "mprotect"}, {11, "munmap"},    {12, "brk"},     {21, "access"},
    {32, "dup"},         {33, "dup2"},     {39, "getpid"},    {41, "socket"},  {42, "connect"},
    {43, "accept"},      {49, "bind"},     {50, "listen"},    {57, "fork"},    {58, "vfork"},
    {59, "execve"},      {60, "exit"},     {62, "kill"},      {72, "fcntl"},   {80, "chdir"},
    {82, "rename"},      {83, "mkdir"},    {84, "rmdir"},     {85, "creat"},   {87, "unlink"},
    {88, "symlink"},     {89, "readlink"}, {101, "ptrace"},   {105, "setuid"}, {158, "arch_prctl"},
    {231, "exit_group"}, {257, "openat"},  {322, "execveat"},
}};

constexpr std::array<Entry, 27> kX86 = {{
    {1, "exit"},         {2, "fork"},         {3, "read"},       {4, "write"},
    {5, "open"},         {6, "close"},        {7, "waitpid"},    {8, "creat"},
    {9, "link"},         {10, "unlink"},      {11, "execve"},    {12, "chdir"},
    {19, "lseek"},       {20, "getpid"},      {37, "kill"},      {41, "dup"},
    {45, "brk"},         {54, "ioctl"},       {63, "dup2"},      {90, "mmap"},
    {91, "munmap"},      {102, "socketcall"}, {125, "mprotect"}, {158, "sched_yield"},
...
constexpr std::array<Entry, 27> kArm = {{
    ...
    {125, "mprotect"},   {158, "sched_yield"}, {192, "mmap2"},
    {220, "getdents64"}, {248, "exit_group"},  {281, "socket"},
    {283, "connect"},    {285, "accept"},      {287, "bind"},
    {322, "openat"},     {387, "execveat"},    {983045, "ARM_set_tls"},
}};

constexpr std::array<Entry, 23> kAarch64 = {{
    {21, "access"},    {35, "unlinkat"}, {56, "openat"},     {57, "close"},   {63, "read"},
    {64, "write"},     {93, "exit"},     {94, "exit_group"}, {129, "kill"},   {172, "getpid"},
    {214, "brk"},      {215, "munmap"},  {220, "clone"},     {221, "execve"}, {222, "mmap"},
    {226, "mprotect"}, {198, "socket"},  {200, "bind"},      {201, "listen"}, {202, "accept"},
    {203, "connect"},  {221, "execve"},  {281, "execveat"},
}};
