...
[[nodiscard]] constexpr std::string_view error_code_name(ErrorCode c) noexcept {
    switch (c) {
        ...
        case ErrorCode::UsageError:       return "UsageError";
        case ErrorCode::InternalError:    return "InternalError";
        case ErrorCode::FeatureDisabled:  return "FeatureDisabled";
        case ErrorCode::IoError:          return "IoError";
        case ErrorCode::PermissionDenied: return "PermissionDenied";
        case ErrorCode::NotFound:         return "NotFound";
        case ErrorCode::InvalidInput:     return "InvalidInput";
        case ErrorCode::SizeExceeded:     return "SizeExceeded";
        case ErrorCode::Unsupported:      return "Unsupported";
        case ErrorCode::Corrupted:        return "Corrupted";
        case ErrorCode::NetworkDisabled:  return "NetworkDisabled";
