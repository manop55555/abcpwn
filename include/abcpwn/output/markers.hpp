...
[[nodiscard]] constexpr std::string_view marker_for_severity(core::Severity s) noexcept {
    switch (s) {
        case core::Severity::Info:     return Marker::info;
        case core::Severity::Low:      return Marker::warn;
        case core::Severity::Medium:   return Marker::warn;
        case core::Severity::High:     return Marker::bad;
        case core::Severity::Critical: return Marker::bad;
    }
    return Marker::info;
}
...
[[nodiscard]] constexpr std::string_view color_for_severity(core::Severity s) noexcept {
    switch (s) {
        case core::Severity::Info:     return Ansi::cyan;
        case core::Severity::Low:      return Ansi::yellow;
        case core::Severity::Medium:   return Ansi::orange_256;
        case core::Severity::High:     return Ansi::red;
        case core::Severity::Critical: return Ansi::bold_red;
    }
    return Ansi::cyan;
}

[[nodiscard]] constexpr std::string_view color_for_marker(std::string_view m) noexcept {
    if (m == Marker::ok)       return Ansi::green;
    if (m == Marker::bad)      return Ansi::red;
    if (m == Marker::warn)     return Ansi::yellow;
    if (m == Marker::info)     return Ansi::cyan;
    if (m == Marker::question) return Ansi::magenta;
    return Ansi::reset;
}
