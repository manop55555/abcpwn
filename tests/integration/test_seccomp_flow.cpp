...
TEST_CASE("seccomp flow: hex decode -> bpf decode -> disassemble",
          "[integration][seccomp]")
{
    ...
    const std::string filter_hex =
        "20000000" "00000000"      // A = sys_number
        "15000100" "3b000000"      // if (A == 0x3b /* SYS_execve */) goto 3
    ...
    const auto lines = abcpwn::commands::seccomp::disassemble_bpf(
